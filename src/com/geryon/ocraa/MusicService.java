...
public class MusicService extends Service implements OnCompletionListener, OnPreparedListener,
    ...
    final static String TAG = "OCRAA-Player";
    ...
    public static final String ACTION_TOGGLE_PLAYBACK =
            "com.geryon.OCRAA.musicplayer.action.TOGGLE_PLAYBACK";
    public static final String ACTION_PLAY = "com.geryon.OCRAA.musicplayer.action.PLAY";
    public static final String ACTION_PAUSE = "com.geryon.OCRAA.musicplayer.action.PAUSE";
    public static final String ACTION_STOP = "com.geryon.OCRAA.musicplayer.action.STOP";
    public static final String ACTION_SKIP = "com.geryon.OCRAA.musicplayer.action.SKIP";
    public static final String ACTION_REWIND = "com.geryon.OCRAA.musicplayer.action.REWIND";
    public static final String ACTION_URL = "com.geryon.OCRAA.musicplayer.action.URL";
    public static final String ACTION_SEEKTO = "com.geryon.OCRAA.musicplayer.action.SEEKTO";
  	public static final String ACTION_UPDATE = "com.geryon.OCRAA.musicplayer.action.UPDATE";
  	public static final String ACTION_TOTAL = "com.geryon.OCRAA.musicplayer.action.TOTAL";
  	public static final String ACTION_SHUFFLE= "com.geryon.OCRAA.musicplayer.action.SHUFFLE";
  	public static final String ACTION_REPEAT= "com.geryon.OCRAA.musicplayer.action.REPEAT";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        else if (action.equals(ACTION_SEEKTO)) processSeekto(intent);
        else if (action.equals(ACTION_SHUFFLE)) processShuffle(intent);
        else if (action.equals(ACTION_REPEAT)) processRepeat(intent);
...
public void processSeekto(Intent intent) {
		int seekTo = intent.getIntExtra("seekto", 0);
    	mPlayer.seekTo(seekTo);
		//Log.i("Seeked to:", String.valueOf(seekTo));
	}
    public void updateProgressBar() {
		progressBarHandler.postDelayed(mUpdateTimeTask, 800);
	}
    private Runnable mUpdateTimeTask = new Runnable() {
		public void run() {
			...
			int progress = (int) currentDuration;
			 Intent in=new Intent(ACTION_UPDATE);  //you can put anything in it with putExtra
		     in.putExtra("progress", progress); 
			// Log.d("MUsicService","sending broadcast");
		        LocalBroadcastManager.getInstance(getApplicationContext()).sendBroadcast(in);
			// Log.d("Progress", ""+progress);
			
			// Running this thread after 100 milliseconds
			progressBarHandler.postDelayed(this,800);
    ...
    void processPlayRequest() {
        if (mState == State.Retrieving) {
            ...
            // ready
            mWhatToPlayAfterRetrieve = position; // play a random song
    ...
    void configAndStartMediaPlayer() {
        ...
        if (!mPlayer.isPlaying()) {
        	mPlayer.start();
        	 updateProgressBar();
        	 Intent in2=new Intent(ACTION_TOTAL);  
		     in2.putExtra("total", mPlayer.getDuration()); 
			 in2.putExtra("name", mSongTitle);
		     
		        LocalBroadcastManager.getInstance(getApplicationContext()).sendBroadcast(in2);
    ...
    //    Log.i("DJTAG", "Belement" );
    	if (mState == State.Retrieving) {
            // we'll play the requested URL right after we finish retrieving
            mWhatToPlayAfterRetrieve = intent.getIntExtra("Uri", -1);
            mStartPlayingAfterRetrieve = true;
        }
        else if (mState == State.Playing || mState == State.Paused || mState == State.Stopped) {
           // Log.i("DJTAG", "Playing from URL/path: " + intent.getData().toString());
           tryToGetAudioFocus();
            playNextSong(intent.getIntExtra("Uri",-1));
        }
    }
    ...
    void updateNotification(String text) {
        PendingIntent pi = PendingIntent.getActivity(getApplicationContext(), 0,
                new Intent(getApplicationContext(), OCRAA.class),
                PendingIntent.FLAG_UPDATE_CURRENT);
        mNotification.setLatestEventInfo(getApplicationContext(), "OCRAA-Player", text, pi);
    ...
    public void onMusicRetrieverPrepared() {
        ...
        if (mStartPlayingAfterRetrieve) {
            tryToGetAudioFocus();
            playNextSong(mWhatToPlayAfterRetrieve == -1 ?
                    -1 : mWhatToPlayAfterRetrieve);
        }
    }
